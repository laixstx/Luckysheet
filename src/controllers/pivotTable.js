...
const pivotTable = {
    ...
    pivotclick: function (row_index, col_index, index) {
        ...
        let pivotDataSheetIndex = file.pivotTable ? file.pivotTable.pivotDataSheetIndex : undefined;
        let real_pivotDataSheetIndex = getSheetIndex(pivotDataSheetIndex);
    ...
    dataHandler: function (column, row, values, showType, celldata) {
        ...
        let rowLen = (datacoltitle.length == 0 ? valuenslen : datacoltitle.length) + (datarowtitle.length == 0 ? valuenslen : datarowtitle.length),
            colLen = (datacoltitle.length == 0 ? valuenslen : datacoltitle[0].length) + (datarowtitle.length == 0 ? valuenslen : datarowtitle[0].length);
